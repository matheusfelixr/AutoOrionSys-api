...
import com.flexsys.entity.RefreshToken;
import com.flexsys.exception.BusinessException;
import com.flexsys.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${flexsys.jwt.refresh-expiration:604800000}") // 7 dias em ms
